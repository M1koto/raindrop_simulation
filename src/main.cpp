...
const string SPHERE0 = "sphere0";
const string SPHERE1 = "sphere1";
const string SPHERE2 = "sphere2";
const string SPHERE3 = "sphere3";
...
//    }
    ...
    if (key == CLOTH) {
      ...
      cp->damping = damping;
      cp->ks = ks;
    } else if (key == SPHERE0 || key == SPHERE1 || key == SPHERE2 || key == SPHERE3) {
      Vector3D origin;
